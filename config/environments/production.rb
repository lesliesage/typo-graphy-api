Rails.application.configure do
  ...
  # Don't compile assets in production. Assets are pre-compiled automatically by Heroku on deploy.
  ...
  # config.active_job.queue_name_prefix = "typo_graphy_production"
  ...
  port:                 587,
  domain:               'web.app', # TODO: is this right
